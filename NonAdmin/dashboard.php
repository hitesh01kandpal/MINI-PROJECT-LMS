            ...
            <div class="col-lg-4 mb-4 mt-4 ">
              <a href="../Courses/template.php?course=<?php echo $counter ?>&course_name=<?php echo $t ?>" style="color:black; text-decoration: none;">
                <div class="card">
                  ...
                  <img src="https://previews.123rf.com/images/nattanitphoto/nattanitphoto1506/nattanitphoto150600008/40933143-icon-vector-of-education-subject-in-black-and-white-can-use-for-website-or-info-graphic.jpg" alt="" class="card-img-top">
                  <div class="card-body">
                    <?php if ($role == "student") : ?>
